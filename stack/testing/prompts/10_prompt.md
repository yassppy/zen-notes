...
Recorre amounts.py y enumera modos de falla agrupados por frontera, equivalencia,
null/vacio y contrato de negocio. Para cada modo de falla, entrega esta estructura:
